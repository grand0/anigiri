...
//@Composable
//fun Modifier.triggerOverscroll(
//    listState: LazyListState,
//    onNewOverscrollAmount: (Float) -> Unit = {},
//    animationSpec: SpringSpec<Float> = spring(stiffness = Spring.StiffnessLow),
//    overscrollThreshold: Dp = 100.dp,
//    onThresholdReached: () -> Unit = {}
//): Modifier {
//    val thresholdPx = with(LocalDensity.current) { overscrollThreshold.toPx() }
//    val orientation by remember { derivedStateOf { listState.layoutInfo.orientation } }
...
//                if (previousValue < thresholdPx && value >= thresholdPx) {
//                    onThresholdReached()
//                }
//                previousValue = value
//            }
...
//            private fun calculateOverscroll(
//                available: Offset,
//            ): Float {
//                val currentValue = overscrollAmountAnimatable.value
...
//                return when {
//                    currentValue > 0 -> newValue.coerceAtLeast(0f)
//                    currentValue < 0 -> newValue.coerceAtMost(0f)
//                    else -> newValue
//                }
//            }
//            
